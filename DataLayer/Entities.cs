...
//    {
//        private Entities(DbConnection conn, bool contextOwnsConnection = true) :
...
//            sqlBuilder.InitialCatalog = "Hotels";
...
//            {
//                connection.Open();
//                // Nếu kết nối mở thành công, thì bạn có thể tiếp tục với các thao tác trên cơ sở dữ liệu ở đây.
//                fs.Close();
...
//                fs.Close();
//                return null; // Hoặc ném một ngoại lệ hoặc trả về giá trị mặc định tùy thuộc vào tình huống của bạn.
//            }
